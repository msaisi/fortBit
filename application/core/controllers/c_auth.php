...
class C_Auth extends MY_Controller {
	...
	public function login() {
		...
		/*retrieve vehicle name by affiliation*/
			...
			/*create session data*/
			$uid=$this->m_systemuser->user_id;
			if($this->m_systemuser->affiliation=="MOPHS" || $this->m_systemuser->affiliation=="N/A")
			{
				$uid="";
			}
			...
			$newdata = array('email' => $this->m_systemuser->email, 'logged_in' => TRUE, 'userRights'=>$this->m_systemuser->userRights,
			          ...
			          'affiliation'=>$this->m_systemuser->affiliation, 'vehicle'=>$vehicle,'user_id'=>$uid);
