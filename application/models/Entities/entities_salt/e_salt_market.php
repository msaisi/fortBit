...
class E_Salt_Market{
		/**
* @Id
* @Column(name="SaltMarketID", type="integer", length=11, nullable=false)
* @GeneratedValue(strategy="AUTO")
* */
private $SaltMarketID;
/**
...
//========================================================================================
public function getSaltMarketID() 
{
		return $this -> SaltMarketID;
}
public function setSaltMarketID($SaltMarketID) 
{ 
$this -> SaltMarketID = $SaltMarketID;
}
//========================================================================================
