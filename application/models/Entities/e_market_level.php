...
/**
 * @Entity
 * @Table(name="foods_markettable")
 */
class E_Market_Level{
		/**
* @Id
* @Column(name="productMarketID", type="integer", length=11, nullable=false)
* @GeneratedValue(strategy="AUTO")
* */
private $productMarketID;
/**
...
private $prod_name;
/**
* @Column(name="vehicle_type", type="string",length=250, nullable=true)
* */
...
/**
* @Column(name="specimen_seal", type="string",length=250, nullable=true)
* */
private $specimen_seal;
/**
...
//========================================================================================
public function getproductMarketID() 
{
		return $this -> productMarketID;
}
public function setproductMarketID($productMarketID) 
{ 
...
//========================================================================================
public function getspecimen_seal() 
{
		return $this -> specimen_seal;
}
public function setspecimen_seal($specimen_seal) 
{ 
$this -> specimen_seal = $specimen_seal;
}
}
?>