 ...
 */
class E_Wheat_Market{
		/**
* @Id
* @Column(name="WheatMarketID", type="integer", length=11, nullable=false)
* @GeneratedValue(strategy="AUTO")
* */
private $WheatMarketID;
/**
...
//========================================================================================
public function getWheatMarketID() 
{
		return $this -> WheatMarketID;
}
public function setWheatMarketID($WheatMarketID) 
{ 
$this -> WheatMarketID = $WheatMarketID;
}
//========================================================================================
