...
/**
 * @Entity
 * @Table(name="maize_productiontable")
 */
class E_Maize_Production{
		/**
* @Id
* @Column(name="MaizeProductionID", type="integer", length=11, nullable=false)
* @GeneratedValue(strategy="AUTO")
* */
private $MaizeProductionID;
...
* */
private $exp_unfort=0;
/**
* @Column(name="fort_brands", type="string",length=250, nullable=true)
* */
private $fort_brands='N/A';
/**
* @Column(name="unfort_brands", type="string",length=250, nullable=true)
* */
private $unfort_brands='N/A';


/**
* @Column(name="company_id", type="string",length=250, nullable=true)
* */
private $company_id;

/**
* @Column(name="signature", type="integer",length=11, nullable=true)
* */
private $signature;
...
//========================================================================================
public function getMaizeProductionID() 
{
		return $this -> MaizeProductionID;
}
public function setMaizeProductionID($MaizeProductionID) 
{ 
$this -> MaizeProductionID = $MaizeProductionID;
}
//========================================================================================
