 ...
 */
class E_Maize_Market{
		/**
* @Id
* @Column(name="MaizeMarketID", type="integer", length=11, nullable=false)
* @GeneratedValue(strategy="AUTO")
* */
private $MaizeMarketID;
/**
...
//========================================================================================
public function getMaizeMarketID() 
{
		return $this -> MaizeMarketID;
}
public function setMaizeMarketID($MaizeMarketID) 
{ 
$this -> MaizeMarketID = $MaizeMarketID;
}
//========================================================================================
