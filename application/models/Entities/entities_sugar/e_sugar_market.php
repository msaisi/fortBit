 ...
 */
class E_Sugar_Market{
		/**
* @Id
* @Column(name="SugarMarketID", type="integer", length=11, nullable=false)
* @GeneratedValue(strategy="AUTO")
* */
private $SugarMarketID;
/**
...
//========================================================================================
public function getSugarMarketID() 
{
		return $this -> SugarMarketID;
}
public function setSugarMarketID($SugarMarketID) 
{ 
$this -> SugarMarketID = $SugarMarketID;
}
//========================================================================================
