 ...
 */
use application\models\Entities\entities_maize\e_maize_production;

class M_Maize_Production  extends MY_Model {
		...
		if ($this -> input -> post()) {//check if a post was made
		   ...
		   //print(($key." ".$val)).'<br \>';
			...
			//iodization centre name obtained from the session variable => 'affiliation'
			 ...
			 {			 	
			 $this -> theForm = new \models\Entities\entities_maize\e_maize_production(); //create an object of the model/*
