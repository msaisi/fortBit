<form name="market_level_wheat" id="market_level_wheat" method="post"
      action="<?php echo base_url() ?>submit/c_form_wheat/fortifiedWheat_market/0" class="form-horizontal">
    <div class="row-fluid">
    ...
    <div class="row-fluid">
     ...
     <div class="row-fluid">
         ...
         <div class="span5">
             ...
             <button type="submit" class="btn btn-warning" formaction="<?php echo base_url() ?>submit/c_form_wheat/fortifiedWheat_market/1">Save and Continue</button>
         </div>
     </div>
</form>