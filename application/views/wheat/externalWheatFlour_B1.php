<form name="externalWheatFlour_B1" id="externalWheatFlour_B1" method="post" action="<?php echo base_url() ?>submit/c_form_wheat/form_externalFort_B1" >
