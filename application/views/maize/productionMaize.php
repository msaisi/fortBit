...
<form name="productionMaize" id="productionMaize" method="post"
      action="<?php echo base_url() ?>submit/c_form_maize/productionMaize/0" class="form-horizontal">
   <h3 align="center">FORTIFIED MAIZE</h3>
   <p align="center">PRODUCTION LOG FOR FORTIFIED MAIZE</p>
   <p align="center">&nbsp;</p>
    <div class="row-fluid">
        <div class="span3" >
          ...
          <select name="maizeFactory" id="maizeFactory" <?php if($sel_compid>1){?>disabled="disabled"	<?php }?>>
    ...
    <div class="span3">
            ...
            <input type="number" id="prodU_1" style="width: 220px !important; height: 25px;" name="prodU_1" class="cloned"/>
             <p>Sales Fortified (Enter 0 for no value)</p>
            <input type="number" id="sales_1" style="width: 220px !important; height: 25px;" name="sales_1" class="cloned" value="0"/>
            <p>Fortified Exports MT</p>
            <input type="number" id="fortExp_1" style="width: 220px !important; height: 25px;" name="fortExp_1" class="cloned"/>
        <p>Sales Export Unfortified</p>
...
<!--</label>	-->	
      ...
      <button type="submit" class="btn btn-primary">Save</button>
        <button type="submit" class="btn btn-warning" formaction="<?php echo base_url() ?>submit/c_form_maize/productionMaize/1">Save and Continue</button>
        </div>
