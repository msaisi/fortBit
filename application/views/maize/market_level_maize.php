<form name="market_level_maize" id="market_level_maize" method="post"
      action="<?php echo base_url() ?>submit/c_form_maize/fortifiedMaize_market/0" class="form-horizontal">
    <div class="row-fluid">
    ...
    <div class="row-fluid">
     ...
     <div class="row-fluid">
         ...
         <div class="span5">
             ...
             <button type="submit" class="btn btn-warning" formaction="<?php echo base_url() ?>submit/c_form_maize/fortifiedMaize_market/1">Save and Continue</button>
         </div>
     </div>
</form>